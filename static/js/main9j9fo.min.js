...
* Licensed under the MIT license (http://www.opensource.org/licenses/mit-license.php)
* Version: 4.0.6
*/__WEBPACK_AMD_DEFINE_ARRAY__=[__webpack_require__(0)],void 0===(__WEBPACK_AMD_DEFINE_RESULT__="function"==typeof(__WEBPACK_AMD_DEFINE_FACTORY__=function(window){var document=window.document;function isWindow(obj){return null!=obj&&obj===obj.window}function isValidElement(elem){return elem instanceof Element}function DependencyLib(elem){return elem instanceof DependencyLib?elem:this instanceof DependencyLib?void(null!=elem&&elem!==window&&(this[0]=elem.nodeName?elem:void 0!==elem[0]&&elem[0].nodeName?elem[0]:document.querySelector(elem),void 0!==this[0]&&null!==this[0]&&(this[0].eventRegistry=this[0].eventRegistry||{}))):new DependencyLib(elem)}return DependencyLib.prototype={on:function(events,handler){if(isValidElement(this[0])){var eventRegistry=this[0].eventRegistry,elem=this[0];function addEvent(ev,namespace){elem.addEventListener?elem.addEventListener(ev,handler,!1):elem.attachEvent&&elem.attachEvent("on"+ev,handler),eventRegistry[ev]=eventRegistry[ev]||{},eventRegistry[ev][namespace]=eventRegistry[ev][namespace]||[],eventRegistry[ev][namespace].push(handler)}for(var _events=events.split(" "),endx=0;endx<_events.length;endx++){var nsEvent=_events[endx].split(".");addEvent(nsEvent[0],nsEvent[1]||"global")}}return this},off:function(events,handler){if(isValidElement(this[0])){var eventRegistry=this[0].eventRegistry,elem=this[0];function removeEvent(ev,namespace,handler){if(ev in eventRegistry==1)if(elem.removeEventListener?elem.removeEventListener(ev,handler,!1):elem.detachEvent&&elem.detachEvent("on"+ev,handler),"global"===namespace)for(var nmsp in eventRegistry[ev])eventRegistry[ev][nmsp].splice(eventRegistry[ev][nmsp].indexOf(handler),1);else eventRegistry[ev][namespace].splice(eventRegistry[ev][namespace].indexOf(handler),1)}function resolveNamespace(ev,namespace){var hndx,hndL,evts=[];if(ev.length>0)if(void 0===handler)for(hndx=0,hndL=eventRegistry[ev][namespace].length;hndx<hndL;hndx++)evts.push({ev:ev,namespace:namespace&&namespace.length>0?namespace:"global",handler:eventRegistry[ev][namespace][hndx]});else evts.push({ev:ev,namespace:namespace&&namespace.length>0?namespace:"global",handler:handler});else if(namespace.length>0)for(var evNdx in eventRegistry)for(var nmsp in eventRegistry[evNdx])if(nmsp===namespace)if(void 0===handler)for(hndx=0,hndL=eventRegistry[evNdx][nmsp].length;hndx<hndL;hndx++)evts.push({ev:evNdx,namespace:nmsp,handler:eventRegistry[evNdx][nmsp][hndx]});else evts.push({ev:evNdx,namespace:nmsp,handler:handler});return evts}for(var _events=events.split(" "),endx=0;endx<_events.length;endx++)for(var nsEvent=_events[endx].split("."),offEvents=resolveNamespace(nsEvent[0],nsEvent[1]),i=0,offEventsL=offEvents.length;i<offEventsL;i++)removeEvent(offEvents[i].ev,offEvents[i].namespace,offEvents[i].handler)}return this},trigger:function(events){if(isValidElement(this[0]))for(var eventRegistry=this[0].eventRegistry,elem=this[0],_events="string"==typeof events?events.split(" "):[events.type],endx=0;endx<_events.length;endx++){var nsEvent=_events[endx].split("."),ev=nsEvent[0],namespace=nsEvent[1]||"global";if(void 0!==document&&"global"===namespace){var evnt,i,params={bubbles:!0,cancelable:!0,detail:arguments[1]};if(document.createEvent){try{evnt=new CustomEvent(ev,params)}catch(e){(evnt=document.createEvent("CustomEvent")).initCustomEvent(ev,params.bubbles,params.cancelable,params.detail)}events.type&&DependencyLib.extend(evnt,events),elem.dispatchEvent(evnt)}else(evnt=document.createEventObject()).eventType=ev,evnt.detail=arguments[1],events.type&&DependencyLib.extend(evnt,events),elem.fireEvent("on"+evnt.eventType,evnt)}else if(void 0!==eventRegistry[ev])if(arguments[0]=arguments[0].type?arguments[0]:DependencyLib.Event(arguments[0]),"global"===namespace)for(var nmsp in eventRegistry[ev])for(i=0;i<eventRegistry[ev][nmsp].length;i++)eventRegistry[ev][nmsp][i].apply(elem,arguments);else for(i=0;i<eventRegistry[ev][namespace].length;i++)eventRegistry[ev][namespace][i].apply(elem,arguments)}return this}},DependencyLib.isFunction=function(obj){return"function"==typeof obj},DependencyLib.noop=function(){},DependencyLib.isArray=Array.isArray,DependencyLib.inArray=function(elem,arr,i){return null==arr?-1:function(list,elem){for(var i=0,len=list.length;i<len;i++)if(list[i]===elem)return i;return-1}(arr,elem)},DependencyLib.valHooks=void 0,DependencyLib.isPlainObject=function(obj){return!("object"!=typeof obj||obj.nodeType||isWindow(obj)||obj.constructor&&!Object.hasOwnProperty.call(obj.constructor.prototype,"isPrototypeOf"))},DependencyLib.extend=function(){var options,name,src,copy,copyIsArray,clone,target=arguments[0]||{},i=1,length=arguments.length,deep=!1;for("boolean"==typeof target&&(deep=target,target=arguments[i]||{},i++),"object"==typeof target||DependencyLib.isFunction(target)||(target={}),i===length&&(target=this,i--);i<length;i++)if(null!=(options=arguments[i]))for(name in options)src=target[name],target!==(copy=options[name])&&(deep&&copy&&(DependencyLib.isPlainObject(copy)||(copyIsArray=DependencyLib.isArray(copy)))?(copyIsArray?(copyIsArray=!1,clone=src&&DependencyLib.isArray(src)?src:[]):clone=src&&DependencyLib.isPlainObject(src)?src:{},target[name]=DependencyLib.extend(deep,clone,copy)):void 0!==copy&&(target[name]=copy));return target},DependencyLib.each=function(obj,callback){var i=0;if(function(obj){var length="length"in obj&&obj.length,ltype=typeof obj;return"function"!==ltype&&!isWindow(obj)&&(!(1!==obj.nodeType||!length)||"array"===ltype||0===length||"number"==typeof length&&length>0&&length-1 in obj)}(obj))for(var length=obj.length;i<length&&!1!==callback.call(obj[i],i,obj[i]);i++);else for(i in obj)if(!1===callback.call(obj[i],i,obj[i]))break;return obj},DependencyLib.data=function(owner,key,value){if(void 0===value)return owner.__data?owner.__data[key]:null;owner.__data=owner.__data||{},owner.__data[key]=value},"function"==typeof window.CustomEvent?DependencyLib.Event=window.CustomEvent:(DependencyLib.Event=function(event,params){params=params||{bubbles:!1,cancelable:!1,detail:void 0};var evt=document.createEvent("CustomEvent");return evt.initCustomEvent(event,params.bubbles,params.cancelable,params.detail),evt},DependencyLib.Event.prototype=window.Event.prototype),DependencyLib})?__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports,__WEBPACK_AMD_DEFINE_ARRAY__):__WEBPACK_AMD_DEFINE_FACTORY__)||(module.exports=__WEBPACK_AMD_DEFINE_RESULT__)},function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var svg4everybody=__webpack_require__(1),svg4everybody_default=__webpack_require__.n(svg4everybody),inputmask_numeric_extensions=__webpack_require__(2),inputmask_numeric_extensions_default=__webpack_require__.n(inputmask_numeric_extensions);function _defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}var Base=function(){function Base(){!function(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}(this,Base)}var Constructor,protoProps,staticProps;return Constructor=Base,staticProps=[{key:"setHeight",value:function($e){function a($e){var h=0;$e.css("height",""),$($e).each(function(e){$(this).outerHeight(!0)>h&&(h=$(this).outerHeight(!0))}),$($e).outerHeight(h)}a($e),$(window).resize(function(){a($e)}),$e.find("img").load(function(){a($e)})}}],(protoProps=null)&&_defineProperties(Constructor.prototype,protoProps),staticProps&&_defineProperties(Constructor,staticProps),Base}();$(document).ready(function(){var context;!function(){function mInputSetState(){$(".form-control").each(function(i,e){""===$(this).val()?($(this).parent().removeClass("is-completed"),$(this).parent().removeClass("is-active")):$(this).parent().addClass("is-active is-completed")})}$.fn.extend({autoHeight:function(){function autoHeight_(element){var a=$(element).outerHeight()-$(element).height();return $(element).css({height:"auto","overflow-y":"hidden"}).height(element.scrollHeight-a)}return this.each(function(){autoHeight_(this).on("input",function(){autoHeight_(this)})})}}),$("body").width()>991&&$(window).height()>650&&($("body").prepend($(".page-header").clone().addClass("fixed-header")),$(window).scroll(function(){$(window).scrollTop()>$(".page-header").outerHeight()+200?($(".fixed-header").addClass("sticky"),$(".page__up").fadeIn()):($(".fixed-header").removeClass("sticky"),$(".page__up").fadeOut())}),$(".page__up").on("click",function(){return $("html:not(:animated),body:not(:animated)").animate({scrollTop:0},800),!1}),$("body").keydown(function(e){"9"==e.which&&$("body").addClass("tab-user")})),svg4everybody_default()(),$(".form-control").focus(function(e){$(this).parent().addClass("is-active is-completed")}),$(".form-control").on("change blur",function(e){mInputSetState()}),mInputSetState(),$(".lightgallery").lightGallery({selector:"a"}),new inputmask_numeric_extensions_default.a("+9 (999) 999-99-99").mask('input[type="tel"]'),$(".selectric").selectric(),$("textarea.form-control").autoHeight(),$(".modal").on("shown.bs.modal",function(e){try{$("textarea.form-control").autoHeight(),$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))}catch(e){var resizeEvent=window.document.createEvent("UIEvents");resizeEvent.initUIEvent("resize",!0,!1,window,0),window.dispatchEvent(resizeEvent)}}),$(".datepicker-here").datepicker({autoClose:!0}),$(".modal").each(function(i,e){$(this).appendTo("body")}),$("[data-js-sync]").on("blur",function(e){var name=$(this).attr("data-js-sync"),val=$(this).val();$("[data-js-sync='".concat(name,"']")).val(val),mInputSetState()}),$(".page__wrapper > *:not(.modal), .page-footer, .page-header").find(".container").each(function(i,e){$(this).closest(".modal").length||$(this).offset().top<$(window).height()||$(this).addClass("wow").addClass("fadeInMy")})}(),$(".b-main").length&&function(){if(!($("body").width()<=991)){$(".page__header + *").children().eq(0).css("padding-top",""),$(".page__header").css("margin-bottom","");var p=parseFloat($(".page__header + *").children().eq(0).css("padding-top")),h=parseFloat($(".page__header").outerHeight()),headH=$(".page__header").outerHeight(),headPadding=p+h;$(".page__header + *").find(".b-main").css("padding-top",headPadding+"px"),$(".page__header").css("margin-bottom",-headH).addClass("page__header_white")}}(),function(){new Swiper(" .b-sport-slider .swiper-container",{effect:"fade",loop:!0,autoplay:{delay:5e3},navigation:{nextEl:".b-sport-slider .swiper-button-next",prevEl:".b-sport-slider .swiper-button-prev"}});Base.setHeight($(".b-sport-slider__slide"))}(),context="b-gropup-slider",new Swiper(".".concat(context," .swiper-container"),{slidesPerView:3,slidesPerGroup:3,spaceBetween:30,loop:!0,autoplay:{delay:4e3},navigation:{nextEl:".".concat(context," .swiper-button-next"),prevEl:".".concat(context," .swiper-button-prev")},breakpoints:{768:{slidesPerView:2,slidesPerGroup:2},550:{slidesPerView:1,slidesPerGroup:1}}}),$(".".concat("b-room-slider__slider")).each(function(i,e){new Swiper($(this).find(".swiper-container"),{loop:!0,autoplay:{delay:6e3},navigation:{nextEl:$(this).find(".swiper-button-next"),prevEl:$(this).find(".swiper-button-prev")}})}),function(){var context="b-spa-slider";new Swiper(".".concat(context," .swiper-container"),{effect:"fade",loop:!0,autoplay:{delay:4e3},navigation:{nextEl:".".concat(context," .swiper-button-next"),prevEl:".".concat(context," .swiper-button-prev")}});Base.setHeight($(".".concat(context,"__slide")))}(),function(){var context="b-rest-slider";new Swiper(".".concat(context," .swiper-container"),{effect:"fade",loop:!0,autoplay:{delay:5e3},navigation:{nextEl:".".concat(context," .swiper-button-next"),prevEl:".".concat(context," .swiper-button-prev")}});Base.setHeight($(".".concat(context,"__slide")))}(),function(){function addMR(){$(".b-entertainment__group").each(function(i,e){var orient=$(this).is(".b-entertainment__group_right")?"margin-right":"margin-left";$(this).css(orient,"");var a=($("body").width()-$(".container").width())/2;$(this).css(orient,-a)})}addMR(),$(window).resize(function(){addMR()}),Base.setHeight($(".b-entertainment__link, .b-entertainment__body"));$(".".concat("b-entertainment__slider")).each(function(i,e){var min,max;new Swiper($(this).find(".swiper-container"),{loop:!0,autoplay:{delay:(min=4e3,max=6e3,Math.random()*(max-min)+min)},slidesPerView:"auto",spaceBetween:0,navigation:{nextEl:$(this).find(".swiper-button-next"),prevEl:$(this).find(".swiper-button-prev")}})})}(),function(){var context="b-about-slider";new Swiper(".".concat(context," .swiper-container"),{effect:"fade",loop:!0,autoplay:{delay:5e3},navigation:{nextEl:".".concat(context," .swiper-button-next"),prevEl:".".concat(context," .swiper-button-prev")}});Base.setHeight($(".".concat(context,"__slide")))}(),function(){var context="b-event-slider";new Swiper(".".concat(context," .swiper-container"),{loop:!0,autoplay:{delay:4e3},slidesPerView:3,slidesPerGroup:3,spaceBetween:30,navigation:{nextEl:".".concat(context," .swiper-button-next"),prevEl:".".concat(context," .swiper-button-prev")},breakpoints:{768:{slidesPerView:2,slidesPerGroup:2,spaceBetween:15},400:{slidesPerView:1,slidesPerGroup:1}}});Base.setHeight($(".".concat(context," .b-event-slider__slide")))}(),function(){var context="b-gallery-slider";new Swiper(".".concat(context," .swiper-container"),{loop:!0,autoplay:{delay:5500},slidesPerView:2,slidesPerGroup:2,spaceBetween:30,navigation:{nextEl:".".concat(context," .swiper-button-next"),prevEl:".".concat(context," .swiper-button-prev")},breakpoints:{768:{slidesPerView:1,slidesPerGroup:1}}});function setMarginRight(){$(".b-gallery-slider .swiper-container").each(function(i,e){$(this).css("margin-right","");var a=($("body").width()-$(".container").width())/2;$("body").width()>991&&a>0&&$(this).css("margin-right",-a)})}Base.setHeight($(".".concat(context," .").concat(context,"__slide"))),setMarginRight(),$(window).resize(function(){setMarginRight()})}(),function(){function loadMap(){if($("#yandex-map-script").length)initMap();else{var script=document.createElement("script");script.src="http://api-maps.yandex.ru/2.1/?lang=ru_RU",script.id="yandex-map-script",document.body.appendChild(script),script.onload=function(){ymaps.ready(function(){initMap()})}}}function initMap(){var zoomInit=$("body").width()>768?16:17,block=$("#mapModal:visible").length?"modal-map":"footer-map";if(!$("#"+block).children().length){var myMap=new ymaps.Map(block,{center:[42.71414206221341,27.75269325557247],zoom:zoomInit,controls:["zoomControl"]}),myPlacemark1=new ymaps.Placemark([42.71414206221341,27.75269325557247],{},{iconLayout:"default#image",iconImageHref:"/static/img/general/pin.png",iconImageSize:[51,50],iconImageOffset:[-25,-50]});myMap.geoObjects.add(myPlacemark1),myPlacemark1.events.add("click",function(e){$('[data-map="1"]').trigger("click")}),myMap.events.add("click",function(e){})}}$("#footer-map").length&&$(window).scroll(function(){$(window).scrollTop()+$(window).height()>$("#footer-map").offset().top&&loadMap()}),$("#mapModal").on("shown.bs.modal",function(){loadMap()})}(),function(){var context="b-media-modal",swiper=new Swiper(".".concat(context," .swiper-container"),{autoHeight:!0,navigation:{nextEl:".".concat(context," .swiper-button-next"),prevEl:".".concat(context," .swiper-button-prev")},on:{init:function(){fixVideo()},slideChangeTransitionStart:function(){fixVideo()}}});function fixVideo(){$('.modal iframe[src*="youtube"]').each(function(i,e){$(this).attr("data-src",$(this).attr("src")),$(this).attr("src",""),$(".b-video-modal__image").show()}),$(".".concat(context," .swiper-slide-active")).find("iframe").attr("src",$(".".concat(context," .swiper-slide-active")).find("iframe").attr("data-src"))}$(".modal").on("hide.bs.modal",function(e){$('.modal iframe[src*="youtube"]').each(function(i,e){$(this).attr("data-src",$(this).attr("src")),$(this).attr("src","")})}),$(".modal").on("shown.bs.modal",function(e){$(e.target).find(".".concat(context)).length&&(fixVideo(),swiper.slideTo(0,0,function(){fixVideo()}))})}(),$('.js-anchor[href^="#"], .page-header__menu-link[href^="#"]').on("click",function(e){var scroll_el=$(this).attr("href"),d=0;return $(".fixed-header").height()&&(d=$(".fixed-header").outerHeight()+30),$("html, body").animate({scrollTop:$(scroll_el).offset().top-d},800),!1}),$(".gamburger").on("click",function(e){return $(this).toggleClass("open"),$("body").toggleClass("menu-open"),$(this).is(".open")?$(".page-header__main-col").slideDown():$(".page-header__main-col").slideUp(),!1}),$("body").css("opacity","1").addClass("body-ready")})}]);